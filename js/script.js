...
<p>${texts.meanings[0].partOfSpeech ? texts.meanings[0].partOfSpeech : "No data found"}</p>
<h1 class="text-2xl mt-2">Synonyms:</h1>
<p>${texts.meanings[0].synonyms[0] ? texts.meanings[0].synonyms[0] : "No data found"}</p>
<h1 class="text-2xl mt-2">Antonyms:</h1>
<p>${texts.meanings[0].antonyms[0] ? texts.meanings[0].antonyms[0] : "No data found"}</p>
<h1 class="text-2xl mt-2">Definition:</h1>
<p>${texts.meanings[0].definitions[0].definition ? texts.meanings[0].definitions[0].definition : "No data found"}</p>
`
}
